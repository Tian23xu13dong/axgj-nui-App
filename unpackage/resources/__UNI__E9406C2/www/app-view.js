...
Z([[4],[[5],[[5],[1,'cu-tag badge']],[[2,'?:'],[[7],[3,'isMan']],[1,'cuIcon-male bg-blue'],[1,'cuIcon-female bg-pink']]]])
Z([3,'avatar-text'])
Z([3,'margin-top:210rpx;font-size:32rpx;'])
Z([a,[[7],[3,'name']]])
Z([3,'cu-list menu sm-border card-menu margin-top'])
Z([3,'cu-item arrow'])
Z([3,'content'])
Z([3,'cuIcon-picfill text-green'])
Z([3,'text-grey'])
Z([3,'头像'])
Z([3,'action'])
...
var z=gz$gwx_1()
var oB=_n('view')
var xC=_mz(z,'cu-custom',['bgColor',0,'bind:__l',1,'isBack',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var oD=_n('view')
_rz(z,oD,'slot',5,e,s,gg)
var fE=_oz(z,6,e,s,gg)
_(oD,fE)
_(xC,oD)
var cF=_n('view')
_rz(z,cF,'slot',7,e,s,gg)
...
var z=gz$gwx_2()
var oJ=_n('view')
var lK=_mz(z,'image',['mode',0,'src',1],[],e,s,gg)
_(oJ,lK)
var aL=_n('text')
...
var z=gz$gwx_3()
var xQ=_n('view')
var oR=_mz(z,'map',['bindmarkertap',0,'controls',1,'data-event-opts',1,'latitude',2,'longitude',3,'markers',4,'scale',5,'style',6],[],e,s,gg)
_(xQ,oR)
_(r,xQ)
return r
}
...
_(hU,oV)
_(cT,hU)
var oX=_mz(z,'swiper',['autoplay',3,'circular',1,'class',2,'duration',3,'indicatorDots',4,'interval',5],[],e,s,gg)
var lY=_v()
_(oX,lY)
...
var o6=_v()
_(x5,o6)
if(_oz(z,13,e2,t1,gg)){o6.wxVkey=1
var c8=_mz(z,'image',['mode',14,'src',1],[],e2,t1,gg)
_(o6,c8)
}
var f7=_v()
_(x5,f7)
if(_oz(z,16,e2,t1,gg)){f7.wxVkey=1
var h9=_mz(z,'video',['autoplay',-1,'loop',-1,'controls',17,'muted',1,'objectFit',2,'showPlayBtn',3,'src',4],[],e2,t1,gg)
_(f7,h9)
}
o6.wxXCkey=1
f7.wxXCkey=1
...
lY.wxXCkey=2
_2z(z,11,aZ,e,s,gg,lY,'item','index','index')
_(cT,oX)
var o0=_n('view')
...
var oHB=_n('view')
_rz(z,oHB,'class',28,aDB,lCB,gg)
var xIB=_v()
_(oHB,xIB)
if(_oz(z,29,aDB,lCB,gg)){xIB.wxVkey=1
var oJB=_n('view')
_rz(z,oJB,'class',30,aDB,lCB,gg)
var fKB=_v()
_(oJB,fKB)
if(_oz(z,31,aDB,lCB,gg)){fKB.wxVkey=1
var cLB=_oz(z,32,aDB,lCB,gg)
_(fKB,cLB)
}
fKB.wxXCkey=1
_(xIB,oJB)
...
cAB.wxXCkey=2
_2z(z,25,oBB,e,s,gg,cAB,'item','__i0__','index')
_(cT,o0)
var cOB=_n('view')
...
var aRB=_mz(z,'image',['mode',37,'src',1],[],e,s,gg)
_(lQB,aRB)
var tSB=_n('view')
...
var o4B=_n('view')
_rz(z,o4B,'class',48,h1B,cZB,gg)
var l5B=_n('view')
_rz(z,l5B,'class',49,h1B,cZB,gg)
var a6B=_n('view')
_rz(z,a6B,'class',50,h1B,cZB,gg)
var t7B=_n('view')
_rz(z,t7B,'class',51,h1B,cZB,gg)
var e8B=_oz(z,52,h1B,cZB,gg)
_(t7B,e8B)
_(a6B,t7B)
_(l5B,a6B)
var b9B=_n('view')
_rz(z,b9B,'class',53,h1B,cZB,gg)
var o0B=_mz(z,'image',['mode',54,'src',1],[],h1B,cZB,gg)
_(b9B,o0B)
var xAC=_n('view')
_rz(z,xAC,'class',56,h1B,cZB,gg)
var oBC=_n('view')
_rz(z,oBC,'class',57,h1B,cZB,gg)
var fCC=_oz(z,58,h1B,cZB,gg)
_(oBC,fCC)
_(xAC,oBC)
var cDC=_n('view')
var hEC=_v()
...
var tKC=_n('view')
_rz(z,tKC,'class',63,oHC,cGC,gg)
var eLC=_oz(z,64,oHC,cGC,gg)
_(tKC,eLC)
_(lIC,tKC)
return lIC
}
hEC.wxXCkey=2
_2z(z,61,oFC,h1B,cZB,gg,hEC,'tag','__i2__','id')
_(xAC,cDC)
_(b9B,xAC)
_(l5B,b9B)
_(o4B,l5B)
...
oXB.wxXCkey=2
_2z(z,46,fYB,e,s,gg,oXB,'item','__i1__','id')
var bMC=_n('text')
...
_(cRC,hSC)
var oTC=_mz(z,'text',['class',4,'style',1],[],e,s,gg)
...
var cJD=_mz(z,'image',['class',31,'mode',1,'src',2],[],e,s,gg)
_(fID,cJD)
var hKD=_n('text')
...
var oND=_mz(z,'navigator',['class',37,'hoverClass',1,'openType',2,'url',3],[],e,s,gg)
var lOD=_n('text')
_rz(z,lOD,'class',41,e,s,gg)
_(oND,lOD)
var aPD=_n('text')
_rz(z,aPD,'class',42,e,s,gg)
var tQD=_oz(z,43,e,s,gg)
_(aPD,tQD)
_(oND,aPD)
_(cMD,oND)
_(oVC,cMD)
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:3662:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:3662:1)",{path:"./app.wxss"});    
